...
//    }
//
//    public static void cppAdditionSIMD(long address, long length, long position){
//        System.out.println("CPP Addition SIMD:");
//        String libraryPath = "src/main/native/liboperations.dylib";
//
//        Chunk chunk = Helper.deserializeChunk(libraryPath, "additionSIMD", address, length, position);
//
//        long[] arrayProperties = Helper.readInt64Vector((Int64Vector) chunk.vectors(new Int64Vector(), 0));
//        MemorySegment memorySegment = Helper.readLongAddress(arrayProperties[0], arrayProperties[2]);
//
...
//        boolean result;
//        try {
//            result = (boolean) getFunctionPointer.invokeExact();
//        } catch (Throwable e) {
...
////        cppAdditionSIMD(ret[0], ret[1], ret[2]);
